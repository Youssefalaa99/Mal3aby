...
<div class="wrap-reg100 p-l-55 p-r-55 p-t-65 p-b-54">
    <form method="POST" action="{{ route('register') }}" class="login100-form validate-form">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" placeholder="Type your Password">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="phonenumber" type="text" class="form-control {{--@error('name') is-invalid @enderror--}}" name="phonenumber" value="{{ old('phonenumber') }}" placeholder="Type your Phonenumber">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phonenumber" type="text" class="form-control {{--@error('name') is-invalid @enderror--}}" name="phonenumber" value="{{ old('phonenumber') }}">
